# Google Business Profile - Quick Start Checklist
...
- [ ] Get their contact info ready for review requests
- [ ] Don't send yet - wait until listing is verified

---

## 📬 WHEN POSTCARD ARRIVES (Day 5-7)
...
### 7. Request Reviews
- [ ] Send review request to 3 past guests
- [ ] Wait 3 days
- [ ] Send to 3 more guests
...
- [ ] Review search queries (what people searched)
...
**Week 1**: Listing created & verified
**Week 2**: 10+ photos uploaded, 5+ reviews requested
**Week 3**: First Google Business clicks to website
**Week 4**: 5+ reviews live, 100+ profile views

**Month 2**: First direct booking from Google
**Month 3**: 2-3 direct bookings/month (saving 15-20% on Airbnb fees!)

---

## ⚠️ IMPORTANT NOTES

1. **Don't skip verification** - Unverified listings don't show in search
2. **Photos are critical** - Listings with 10+ photos get 2x more engagement
3. **Reviews boost ranking** - Each 5-star review improves your position
4. **Post weekly** - Active businesses rank higher
5. **Respond fast** - Google tracks response time (aim for <24 hours)
...
3. Create "Indigo Palm Collective" business for umbrella brand
...
Common issues:
- **Can't find property address**: Try variations of street format
- **Already claimed by someone**: Request ownership via "Claim this business"
- **No postcard option**: Try email or phone verification
- **Photos rejected**: Must be 720x720px minimum, no promotional text
